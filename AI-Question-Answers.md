...
The AI converts the prompt into tokens, uses the conversation context and its trained model, then predicts the most likely next words to generate a response. 

Better prompts provide clearer context and usually produce better answers.
